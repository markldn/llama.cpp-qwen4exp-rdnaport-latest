...
void ggml_compute_forward_moe_lru_ensure(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_moe_expert_copy(const struct ggml_compute_params * params, struct ggml_tensor * dst);
