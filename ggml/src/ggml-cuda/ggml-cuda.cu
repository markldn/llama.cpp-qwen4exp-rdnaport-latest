...
static ggml_cuda_device_info ggml_cuda_init() {
    ...
    for (int id = 0; id < info.device_count; ++id) {
        ...
        // async-safe operation at no decode/prefill cost. Kept permanently
        // disabled on HIP even if upstream later re-enables it for CUDA once
        // #15034 is fixed there - that fix wouldn't cover this HIP-specific bug.
