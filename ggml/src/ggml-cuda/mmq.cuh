...
struct mmq_args {
    ...
    // Placed after ncols_opt (not before) so existing positional aggregate-init call sites
    // that only supply through ncols_opt still compile correctly and leave these at their
    // defaults.
